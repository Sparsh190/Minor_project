...
<div className="text-white body-font">
  <div className="container mx-auto flex flex-wrap justify-between px-4 py-2 items-center">
    ...
    {localStorage.getItem('username') && <div className="flex gap-5">
      <button className=" text-black inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
      <a href="/report">
        Profile &rarr;
      </a>
    </button> 
      <button className=" text-black inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0" onClick={()=>localStorage.removeItem('username')}>
        <a href="/">
        Logout &rarr;
        </a>
    </button> 
