...
function page() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-4xl text-3xl font-black title-font mb-4 text-white">Leaderboard Ranking</h1>
    </div>
      ...
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400">Score : 95%</p>
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400">Score : 94%</p>
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400">Score : 91%</p>
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400">Score : 89%</p>
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400">Score : 85%</p>
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400">Score : 81%</p>
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
      <div className="p-2 w-full">
        <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-400">Score : 69%</p>
            <p className="text-gray-400 underline w-fit cursor-pointer">View Detailed Result</p>
          </div>
        </div>
      </div>
